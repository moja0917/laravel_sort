        ...
        <thead>
            <tr>
                <th style="cursor: pointer" onclick="window.location=`{{ $sort === 'titleAsc' }}`?
                    ...
                    `{{ route('todos.index', ['queryText=' . $queryText, 'status=' . $status,  'sort=titleAsc']) }}`" @if ($sort==='titleAsc' ) <i class="fas fa-arrow-up"></i> @endif
                ...
                <th style="cursor: pointer" onclick="window.location=`{{ $sort === 'statusAsc' }}`?
                    ...
                    `{{ route('todos.index', ['queryText=' . $queryText, 'status=' . $status, 'sort=statusAsc']) }}`" @if ($sort==='statusAsc' ) <i class="fas fa-arrow-up"></i> @endif
